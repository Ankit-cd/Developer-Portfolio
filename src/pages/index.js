...
export default function Home() {
  return (
    <>
      ...
      <TransitionEffect/>
      <main className='flex items-center text-dark w-full h-full min-h-screen dark:text-light'>
        <Layout className='pt-0 md:p-16 sm:pt-8'>
          <div className="flex items-center justify-between w-full h-full lg:flex-col">
            <div className="w-1/2 md:w-full">
              <Image src={profilepic} alt='Ankit' className='w-full h-auto lg:hidden md:inline-block md:w-full'
                priority
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              <AnimatedText text={"Turning Vision Into Reality With Code And Design."} className='xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl' />
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href={"/jobresume.pdf"} target={'_blank'} className='flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold
                ...
                <Link href="mailto:ankitmehta4526@gmail.com" target={'_blank'}
        ...
        <div className='absolute right-6 bottom-2 inline-block w-24 md:hidden'>
